...
// scroll bades
// https://cdnjs.com/libraries/lodash.js lodash cdn
// https://cdnjs.com/libraries/gsap gsap cdn
...
window.addEventListener(
  ...
  _.throttle(() => {
    ...
    // bades를 보이거나 안 보이게 처리 스크롤 값이 500이상이면 안 보이고, 이하이면 보이게
...
const swiper2 = new Swiper(".promotion .swiper", {
  ...
  pagination: {
    ...
    clickable: true, //페이지 표시 (원)을 클릭하면 해당하는 슬라이드로 이동
  },
  navigation: {
...
function random(min, max) {
  // toFixed()를 통해 반환된 문자 데이터를 parseFloat()를 통해 소수점을 가져오는 숫자 데이터로 반환
